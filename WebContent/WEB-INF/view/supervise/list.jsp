...
<meta charset="UTF-8">
<meta name="viewport"
	content="width=device-width, Supervise-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="SuperviseList"
								method="post">
								<div class="form-group">
									<input type="text" name="key" value="${key}"
										class="form-control" placeholder="督办员工姓名">
								</div>
							...
							<!-- <a class="btn btn-primary float-right" href="Supervise_create.html"><i
									...
									<c:forEach items="${pageInfo.list}" var="data">
										...
										>
											...
											<td><input id="${data.id}" value="${data.id}" 
												...
												href="toUpdateSupervise?id=${data.id }">修改</a> <a class="btn btn-danger btn-sm del"
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="SuperviseList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="SuperviseList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>
                ...
                <li class="page-item"><a class="page-link" href="#">3</a></li> -->
								...
								<li class="page-item"><a class="page-link"
									href="SuperviseList?currentPage=${pageInfo.pages}">尾页</a></li>
