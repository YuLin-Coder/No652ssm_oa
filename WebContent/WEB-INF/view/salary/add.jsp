								...
								<div class="col-5">
									<form id="saveForm">
										...
										<div class="form-group">
											...
											<input type="text" name="worktime" id="worktime"  class="form-control" autocomplete="off"   onClick="WdatePicker({el:this,dateFmt:'yyyy-MM'})"> 
												<small class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>税前工资</label> <input type="number" name="sqmoeny" id="sqmoeny"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>税款</label> <input type="number" name="jsmoney" id="jsmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>五险</label> <input type="number" name="wxmoney" id="wxmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>社保</label> <input type="number" name="sbmoney" id="sbmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>公积金</label> <input type="number" name="gjjmoney" id="gjjmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>补贴</label> <input type="number" name="btmoney" id="btmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group"> 
											<label>过节费</label> <input type="number" name="gjmoeny" id="gjmoeny"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>加班工资</label> <input type="number" name="jbmoney" id="jbmoney"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
