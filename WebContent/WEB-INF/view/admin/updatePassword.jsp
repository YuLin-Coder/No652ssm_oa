								...
								<div class="col-5">
									<form id="saveForm">
										<div class="form-group">
											...
											<input type="text" name="nowpass" id="nowpass"  class="form-control" autocomplete="off"   onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm'})"> 
												<small class="form-text text-muted"></small>
										</div>
										<div class="form-group">
											<label>新密码</label> 
											
											<input type="text" name="newpass" id="newpass"  class="form-control" autocomplete="off"   onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm'})"> 
												<small class="form-text text-muted"></small>
										</div>
									</form>
								</div>
