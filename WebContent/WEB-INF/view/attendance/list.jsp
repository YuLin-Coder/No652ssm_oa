		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="AttendanceList"
								method="post">
								<div class="form-group">
									<input type="text" name="key" value="${key}"
										class="form-control" placeholder="考勤员工姓名">
								</div>
							...
							<!-- <a class="btn btn-primary float-right" href="Attendance_create.html"><i
						...
						<div class="table-box">
							...
							<table class="table">
								<thead>
									<tr>
										<th scope="col">考勤人姓名</th>
										<th scope="col">考勤时间</th>
									...
									<c:forEach items="${pageInfo.list}" var="data">
										<tr>
											...
											<td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateAttendance?id=${data.id }">修改</a> <a class="btn btn-danger btn-sm del"
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="AttendanceList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="AttendanceList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>
                ...
                <li class="page-item"><a class="page-link" href="#">3</a></li> -->
								...
								<li class="page-item"><a class="page-link"
									href="AttendanceList?currentPage=${pageInfo.pages}">尾页</a></li>
